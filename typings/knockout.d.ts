...
interface KnockoutUtils {
    ...
    catchFunctionErrors(delegate: Function);
    setTimeout(handler: Function, timeout: number);
    deferError(error: any);
...
/////////////////////////////////
interface KnockoutTaskHandle {
}

interface KnockoutTask {
    schedule: () => KnockoutTaskHandle;
    cancel: (handle: KnockoutTaskHandle) => void;
    runEarly: () => void;
}

interface KnockoutOptions {
    deferUpdates: boolean; //default: false
    useOnlyNativeEvents: boolean; // default: false
}
